kikit panelize \
    ...
    --post 'millradius: 1mm' \
    ../bobbin_top_3.5.kicad_pcb bobbin_top_3.5_panel.kicad_pcb

kikit fab jlcpcb --no-drc bobbin_top_3.5_panel.kicad_pcb .
mv gerbers.zip bobbin_top_3.5_gerbers.zip
