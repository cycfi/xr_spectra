kikit panelize \
    ...
    --post 'millradius: 1mm' \
    ../bobbin_bottom_3.3.kicad_pcb bobbin_bottom-3.3_panel.kicad_pcb

kikit fab jlcpcb --no-drc bobbin_bottom-3.3_panel.kicad_pcb .
mv gerbers.zip bobbin_bottom-3.3_gerbers.zip
