kikit panelize \
    ...
    --post 'millradius: 1mm' \
    ../coil_cover_bottom_82.kicad_pcb coil_cover_bottom_82_panel.kicad_pcb

kikit fab jlcpcb --no-drc coil_cover_bottom_82_panel.kicad_pcb .
mv gerbers.zip coil_cover_bottom_82_gerbers.zip
