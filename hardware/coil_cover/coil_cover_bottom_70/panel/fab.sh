kikit panelize \
    ...
    ../coil_cover_bottom_70.kicad_pcb coil_cover_bottom_70_panel.kicad_pcb

kikit fab jlcpcb --no-drc coil_cover_bottom_70_panel.kicad_pcb .
mv gerbers.zip coil_cover_bottom_70_gerbers.zip
