kikit panelize \
    ...
    ../coil_cover_top_82.kicad_pcb coil_cover_top_82_panel.kicad_pcb

kikit fab jlcpcb --no-drc coil_cover_top_82_panel.kicad_pcb .
mv gerbers.zip coil_cover_top_82_gerbers.zip
